...
<body>
    ...
    <div class="container bg-warning bg" align="center"><br>
        <form class="form-group" id="formv" enctype="multipart/form-data" method="post">
            <h1 class="text-dark">Update Foods</h1><br>
            ...
            <input type="text" id="fname" name="fname" placeholder="  Enter New Food Name" class="form-control"><br><br>
            <label for="eprice">Food Expected Price:</label>
            <input type="number" id="eprice" name="eprice" placeholder="  Enter New Food Expected Price" class="form-control"><br><br>
            <label for="aprice">Food Actual Price:</label>
            <input type="number" id="aprice" name="aprice" placeholder="Enter New Food Actual Price" class="form-control"><br><br>
            <label for="fimgage">Upload Food Image:</label>
            <input type="file" id="fimage" name="fimage" accept="jpg,png"><br><br> 
            <label for="dfood">Food Description:</label>
            <input type="text" id="dfood" name="dfood" placeholder="Enter New Food Details" class="form-control"><br><br>
...
if sub != None and len(v) != 0:
    ...
    if fimg.filename:
        ...
        q = """update foods set Foodname='%s',Price='%s',ActualPrice='%s',Details='%s',Food_Image='%s' where Fid='%s' """ % (fname, ep, ap, df, fn,fid)
        cur.execute(q)
        con.commit()
        print("""<script>
